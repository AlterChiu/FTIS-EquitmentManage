...
(function () {
    ...
    var genBootstrapAccordion = function ($_container, _id, _classes, _heads, _contents) {
        ...
        for (var _idx = 0; _idx < _heads.length; _idx++) {
            ...
            $('<div class="panel-heading" role="tab"><h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#' + id + '" href="#content' + _idx + '-' + id + '" aria-expanded="true" aria-controls="content' + _idx + '-' + id + '">' + _heads[_idx] + '</a></h4></div>').appendTo($_panel);
